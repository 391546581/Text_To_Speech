...
//}
    ...
    private void initUI() {
        edit = (EditText) findViewById(R.id.test_text);
        languageGroup= (RadioGroup) findViewById(R.id.language_Group);
        english = (RadioButton) findViewById(R.id.language_English);
        chainese = (RadioButton) findViewById(R.id.language_Chainese);
        german = (RadioButton) findViewById(R.id.language_German);
        french = (RadioButton) findViewById(R.id.language_French);
        taiWan=(RadioButton) findViewById(R.id.language_TaiWan);
